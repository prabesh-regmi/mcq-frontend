  ...
  const onDrop = React.useCallback(
    (acceptedFiles: File[], fileRejections: any[]) => {
      ...
      if (acceptedFiles && acceptedFiles.length > 0) {
        ...
        setFileError(
          "File is not accepted. Please upload a valid CSV or Excel file."
        );
        setFile(null);
      }
    },
  ...
  const confirmDeleteRows = () => {
    setPreview((prev: any) => ({
      ...
      questions: prev.questions.filter(
        (_: any, i: number) => !selectedRows.includes(i)
      ),
    }));
    setSelectedRows([]);
  ...
  const handleConfirm = async () => {
    ...
    try {
      await adminAPI.bulkCreateQuestions({
        ...
        newSubjects: Array.isArray(preview.newSubjects)
          ? preview.newSubjects
          : [],
      });
      setSuccess(true);
  ...
  return (
    <div className="space-y-4">
            ...
            {file ? (
              ...
              <>
                ...
                <span className="text-xs text-muted-foreground mt-1">
                  Supported: .csv, .xlsx, .xls &middot; Max size: 5MB
                </span>
              </>
            )}
          </div>
        ...
        <div>
          ...
          {preview?.detail ? (
            <div className="text-center text-destructive py-8 font-medium">
              There was an error processing your file. Please check your
              template and data.
              <br />
              {preview.detail}
            </div>
            ...
            <div className="text-center text-muted-foreground py-8">
              No questions found in the uploaded file. Please check your
              template and data.
            </div>
          ) : (
            <div className="overflow-x-auto w-full">
              <table className="w-full border text-sm table-fixed overflow-x-auto">
                <thead className="bg-card min-w-[600px]">
                  <tr>
                      ...
                      <td className="p-4 w-12">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            handleSelectRow(idx, checked as boolean)
                          }
                        />
                      </td>
                      <td className="p-4 max-w-xs whitespace-pre-wrap w-1/4">
                        {q.text}
                      </td>
                            ...
                            <Tooltip.Trigger asChild>
                              ...
                              >
                                ...
                                <svg
                                  ...
                                  viewBox="0 0 24 24"
                                >
                                  <path d="M15.232 5.232l3.536 3.536M9 13l6.586-6.586a2 2 0 1 1 2.828 2.828L11.828 15.828a4 4 0 0 1-2.828 1.172H7v-2a4 4 0 0 1 1.172-2.828z" />
                                </svg>
                              </Button>
                            </Tooltip.Trigger>
          ...
          <div className="sticky bottom-0 bg-background p-4 z-10 flex justify-center md:justify-end gap-2 md:gap-4 items-center border-t">
            ...
            <Button
              ...
              className="border-red-400 text-red-400 hover:bg-red-50 hover:text-red-400 dark:hover:bg-red-950 dark:hover:text-white"
            >
              Delete Selected
            </Button>
            <Button
      ...
      <Dialog open={success} onOpenChange={setSuccess}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Bulk Upload Success</DialogTitle>
          </DialogHeader>
      ...
      >
        <DialogContent>
          ...
          <div className="py-4 text-destructive font-medium">
            Are you sure you want to delete the selected questions? This action
            cannot be undone.
          </div>
          <DialogFooter>
            <Button
            ...
            <Button variant="destructive" onClick={confirmDeleteRows}>
              Delete
            </Button>
          </DialogFooter>
        </DialogContent>
